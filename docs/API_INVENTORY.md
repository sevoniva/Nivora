...
| Release orchestration | releases, release artifacts, release cancel, plan/deploy, executions, targets, timeline, cancel/resume, release evidence | sequential local orchestration foundation; release cancel marks the Release and cancels non-terminal ReleaseExecutions, but does not run rollback or delete resources |
