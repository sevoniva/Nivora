...
| Compliance Audit/Evidence | Partial | Structured AuditLog fields, audit search, evidence bundle JSON/Markdown export, retention policy metadata, guarded retention preview/evidence cleanup | Immutable external audit store, scheduled retention jobs, compliance attestations |
