...
This inventory lists the main documentation areas and their purpose.

- `PROJECT_CHARTER.md`: project identity, principles, current status, and collaboration model.
- `README.md`: concise entry point for users and contributors, including current maturity and capability links.
