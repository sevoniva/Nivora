...
verify-enterprise-readiness:
	./scripts/verify-enterprise-readiness.sh
...
verify: fmt-check tidy-check vet test build verify-architecture verify-no-secrets verify-examples verify-runtime verify-api verify-cli verify-api-specs verify-workflow verify-deployment verify-release verify-security verify-host verify-web verify-packaging verify-helm-safety verify-enterprise-readiness verify-alpha verify-translations verify-mcp
	@echo "=== verify passed ==="
...
smoke-upgrade-migration-compatibility:
	./scripts/smoke-upgrade-migration-compatibility.sh
