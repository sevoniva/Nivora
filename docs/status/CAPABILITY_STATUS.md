...
| Production doctor | foundation | `internal/usecase/doctor`, `nivora doctor`, `docs/operations/production-doctor.md`, config safety tests | Read-only config posture checks for production-like installs. It does not prove production readiness and does not yet connect to live database, migration, runner, or audit-chain checks. |
