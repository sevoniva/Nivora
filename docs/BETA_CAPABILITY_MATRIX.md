...
| Compliance Audit | Partial beta | structured audit model, audit search, evidence bundles, retention policy metadata, guarded retention preview/evidence cleanup, JSON/Markdown export | immutable external audit store, scheduled retention jobs, compliance certification |
