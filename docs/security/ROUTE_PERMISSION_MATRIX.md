...
| GET | `/api/v1/evidence/bundles` | `audit.read` | audit/evidence | user/service account | yes | no | yes | Lists persisted evidence bundles by optional subject filters; values are redacted. |
