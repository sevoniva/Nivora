...
| Artifact | Implemented foundation | OCI reference parsing, digest pin recognition, mutable tag warnings, generic OCI digest resolution foundation | Full Harbor/Nexus/JFrog management APIs, signing, scanning, registry CRUD |
