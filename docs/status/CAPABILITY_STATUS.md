...
| Auth/RBAC | partial | `internal/usecase/auth`, auth middleware tests | Dev/token/OIDC foundation and selected permission checks; full enterprise SSO and route coverage remain incomplete. |
