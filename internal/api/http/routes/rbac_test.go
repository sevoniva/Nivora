...
var criticalRoutes = []struct {
	...
	{"GET", "/api/v1/release-targets", domainauth.PermissionEnvironmentRead, false},
	{"POST", "/api/v1/release-targets", domainauth.PermissionEnvironmentWrite, true},
	{"PATCH", "/api/v1/release-targets/target-1", domainauth.PermissionEnvironmentWrite, true},
	{"DELETE", "/api/v1/release-targets/target-1", domainauth.PermissionEnvironmentWrite, true},
	{"POST", "/api/v1/release-targets/target-1/validate", domainauth.PermissionDeploymentCreate, true},
	...
	{"POST", "/api/v1/repositories/repo-1/validate", domainauth.PermissionProjectRead, false},
	{"POST", "/api/v1/repositories/repo-1/snapshot", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/repositories/repo-1/snapshots", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/repositories/repo-1/intelligence", domainauth.PermissionProjectRead, false},
	{"POST", "/api/v1/repositories/repo-1/analyze", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/repositories/repo-1/devops-plans", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/repositories/repo-1/devops-plan/latest", domainauth.PermissionProjectRead, false},
	{"POST", "/api/v1/devops/plan", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/devops/plans/plan-1", domainauth.PermissionProjectRead, false},
	{"POST", "/api/v1/devops/readiness-review", domainauth.PermissionProjectRead, false},
	{"POST", "/api/v1/workflows/validate", domainauth.PermissionWorkflowPlan, false},
	{"POST", "/api/v1/workflows/plan", domainauth.PermissionWorkflowPlan, false},
	{"GET", "/api/v1/workflows", domainauth.PermissionWorkflowPlan, false},
	...
	{"GET", "/api/v1/workflows/workflow-rbac", domainauth.PermissionWorkflowPlan, false},
	{"GET", "/api/v1/workflows/workflow-rbac/plan", domainauth.PermissionWorkflowPlan, false},
	...
	{"POST", "/api/v1/workflows/runs/wrun-rbac/cancel", domainauth.PermissionWorkflowRun, true},
	{"POST", "/api/v1/workflows/runs/reconcile", domainauth.PermissionWorkflowRun, true},
	{"POST", "/api/v1/workflows/runs/wrun-rbac/retry", domainauth.PermissionWorkflowRun, true},
	...
	{"POST", "/api/v1/pipelines/pipe-1/rollback", domainauth.PermissionProjectWrite, true},
	...
	{"GET", "/api/v1/deployments", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/deployments/dep-1", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/deployments/dep-1/plan", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/deployments/dep-1/resources", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/deployments/dep-1/health", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/deployments/dep-1/diff", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/deployments/dep-1/logs", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/deployments/dep-1/events", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/deployments/dep-1/timeline", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/deployments/dep-1/security", domainauth.PermissionProjectRead, false},
	{"POST", "/api/v1/releases", domainauth.PermissionReleaseCreate, true},
	{"GET", "/api/v1/releases", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/releases/rel-1", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/releases/rel-1/artifacts", domainauth.PermissionProjectRead, false},
	...
	{"POST", "/api/v1/releases/executions/rexec-1/cancel", domainauth.PermissionDeploymentCancel, true},
	...
	{"GET", "/api/v1/artifact-registries/areg-1/artifacts", domainauth.PermissionProjectRead, false},
	{"POST", "/api/v1/artifact-registries/areg-1/validate", domainauth.PermissionProjectRead, false},
	{"POST", "/api/v1/artifact-registries", domainauth.PermissionCredentialManage, true},
	{"PATCH", "/api/v1/artifact-registries/areg-1", domainauth.PermissionCredentialManage, true},
	{"DELETE", "/api/v1/artifact-registries/areg-1", domainauth.PermissionCredentialManage, true},
	...
	{"GET", "/api/v1/security/scans", domainauth.PermissionProjectRead, false},
	{"POST", "/api/v1/security/scans", domainauth.PermissionPolicyManage, true},
	{"GET", "/api/v1/security/findings", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/security/findings/finding-1", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/policies", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/policies/results", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/policies/results/policy-result-1", domainauth.PermissionProjectRead, false},
	...
	{"POST", "/api/v1/retention-policy/run", domainauth.PermissionPolicyManage, true},
	{"GET", "/api/v1/events", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/logs", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/timeline", domainauth.PermissionProjectRead, false},
	...
	{"GET", "/api/v1/visualization/pipeline-runs/prun-1/dag", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/visualization/pipeline-runs/prun-1/timeline", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/visualization/pipeline-runs/prun-1/summary", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/visualization/deployments/dep-1/timeline", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/visualization/deployments/dep-1/resources", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/visualization/deployments/dep-1/diff", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/visualization/deployments/dep-1/health", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/visualization/releases/rel-1/overview", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/visualization/releases/executions/rexec-1/timeline", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/visualization/releases/executions/rexec-1/targets", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/visualization/environments/env-1/topology", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/visualization/runners/summary", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/visualization/security/summary", domainauth.PermissionProjectRead, false},
	{"POST", "/api/v1/pipeline-runs", domainauth.PermissionPipelineRun, true},
	{"GET", "/api/v1/pipeline-runs/prun-1", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/pipeline-runs/prun-1/dag", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/pipeline-runs/prun-1/jobs", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/pipeline-runs/prun-1/steps", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/pipeline-runs/prun-1/logs", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/pipeline-runs/prun-1/artifacts", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/pipeline-runs/prun-1/caches", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/pipeline-runs/prun-1/annotations", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/pipeline-runs/prun-1/summary", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/pipeline-runs/prun-1/events", domainauth.PermissionProjectRead, false},
	{"GET", "/api/v1/pipeline-runs/prun-1/timeline", domainauth.PermissionProjectRead, false},
